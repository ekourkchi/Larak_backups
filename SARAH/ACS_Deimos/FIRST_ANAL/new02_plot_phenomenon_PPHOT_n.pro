pro new02_plot_phenomenon_PPHOT_n, psout


;  new02_plot_phenomenon_PPHOT_n, 'testjagour01_v2.ps'    
...
h1=-0.16
v=0.15
plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.3,1.1], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3.,ytitle='log(n)', xtitle='a*log(R!De!N)+b*!7l!X!D0!N!D(814)!N+c'
ans=ortptrend(y,x,z)
print, ans
ans0=ortptrenderror(y,x,z,yer,xer,zer,iter)
print, ans0
del=abs(ans[0]*y+ans[1]*x+ans[2]-z)
rm=stdev(del^2)
print, "DEX=", sqrt(rm[0])
xyouts, -0.30-v, 0.70-h1, '(n)!DRMS!N: '+strtrim(string(sqrt(rm[0]), FORMAT='(F5.3)'),2)+' DEX', color=cc[0], size=1.3
oplot, [-0.35-v], [0.715-h1], psym= yoursymbol(27,color=cc[50])
del=abs((z-ans[1]*x-ans[2])/ans[0]-y)
rm=stdev(del^2)
xyouts, 0.05, -0.15, 'RMS(R!De!N): '+strtrim(string(sqrt(rm[0]), FORMAT='(F5.3)'),2)+' DEX', color=cc[0], size=1.3





oplot, ans[0]*y+ans[1]*x+ans[2], z, psym= yoursymbol(27,color=cc[50])
oplot, [-0.35-v], [0.815-h1], psym= yoursymbol(27,color=cc[50])
xyouts, -0.30-v, 0.8-h1, 'M!D814!N<-20', color=cc[0], size=1.3

x=modmu0_original
y=modre814kpc
z=modlogn
xer=modermu0_original
yer=moderre814kpc
zer=moderlogn
del=abs(ans[0]*y+ans[1]*x+ans[2]-z)
rm=stdev(del^2)
print, "DEX(tot)=", sqrt(rm[0])
xyouts, -0.30-v, 0.60-h1, '(n)!DRMS!N: '+strtrim(string(sqrt(rm[0]), FORMAT='(F5.3)'),2)+' DEX', color=cc[0], size=1.3
oplot, [-0.35-v], [0.615-h1], psym= yoursymbol(27,color=cc[50])
oplot, [-0.40-v], [0.615-h1], psym= yoursymbol(25,color=cc[30])
box, [-0.44-v,0.55-h],[0.50-v,0.86-h], linestyle=0, color=cc[0], thick=2.  ; [x1,y1] [x2,y2]


x=modmu0_original[where(modmag ge limag or modmag le dwmag)]
y=modre814kpc[where(modmag ge limag or modmag le dwmag)]
z=modlogn[where(modmag ge limag or modmag le dwmag)]
xer=modermu0_original[where(modmag ge limag or modmag le dwmag)]
yer=moderre814kpc[where(modmag ge limag or modmag le dwmag)]
zer=moderlogn[where(modmag ge limag or modmag le dwmag)]
oplot, ans[0]*y+ans[1]*x+ans[2], z,psym= yoursymbol(25,color=cc[30])
...
xyouts, 0.85,1.0,'(A)', color=cc[0], size=1.1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
multiplot
...
h=-0.17
h1=-0.16
plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.3,1.1], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3., xtitle='a*log(R!De!N)+b*!7l!X!D0!N!D(814)!N+c'
ans=ortptrend(y,x,z)
...
xyouts, px,py-0.2,'c='+strtrim(string(ans[2], FORMAT='(F5.2)'),2)+'!M+!X'+strtrim(string(ans0[5], FORMAT='(F5.2)'),2), color=cc[0], size=1.2
;xyouts, 21.0,18.1,'(FP-F814W)', color=cc[50], size=1.1
xyouts, 0.85,1.0,'(B)', color=cc[0], size=1.1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
multiplot
...
!p.charsize=1.4
AXIS, XAXIS=0,xrange=[-0.70,1.0], xstyle=1, xtickinterval=0.3, xminor=3, /noerase, xtitle='a*log(R!De!N)+b*!7l!X!D0!N!D(814)!N+c'
...
xyouts, px,py-0.2,'c='+strtrim(string(ans[2], FORMAT='(F5.2)'),2)+'!M+!X'+strtrim(string(ans0[5], FORMAT='(F5.2)'),2), color=cc[0], size=1.2
;xyouts, 21.0,18.1,'(FP-F814W)', color=cc[50], size=1.1
xyouts, 0.85,1.0,'(C)', color=cc[0], size=1.1
...
;h=-0.17
;h1=-0.16
;plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.3,1.1], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3., xtitle='a*log(R!De!N)+b*!7l!X!D0!N!D(814)!N+c',ytitle='log(n)';
;ans=ortptrend(y,x,z)
...
;xyouts, px,py-0.2,'c='+strtrim(string(ans[2], FORMAT='(F5.2)'),2)+'!M+!X'+strtrim(string(ans0[5], FORMAT='(F5.2)'),2), color=cc[0], size=1.2
		;xyouts, 21.0,18.1,'(FP-F814W)', color=cc[50], size=1.1
;xyouts, 0.85,1.0,'(D)', color=cc[0], size=1.1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;multiplot
...
;xyouts, px,py-0.2,'c='+strtrim(string(ans[2], FORMAT='(F5.2)'),2)+'!M+!X'+strtrim(string(ans0[5], FORMAT='(F5.2)'),2), color=cc[0], size=1.2
		;xyouts, 21.0,18.1,'(FP-F814W)', color=cc[50], size=1.1
;xyouts, 0.85,1.0,'(E)', color=cc[0], size=1.1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
