...
plot, [0], /nodata, xthick=2.,ythick=2.,charsize=0.9, xtickinterval=0.2, xminor=2, xrange=[minn,maxx], yrange=[0,max(hist)+10.], yminor=5, xtitle='Delta R Magnitude (image-SDSS)', ytitle='!6Number of Objects',title='!6Delta Mag. Histogram ('+str+')', color=cc[0]
