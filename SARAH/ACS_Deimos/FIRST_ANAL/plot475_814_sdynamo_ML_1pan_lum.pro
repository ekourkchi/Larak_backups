pro plot475_814_sdynamo_ML_1pan_lum, psout, limag
...
ccc74=ccc74[where(modgmp3 ne 0)]
		...
		xtitl="M!DF475W!N [Mag]"
		ytitl="log(M/L) [(M/L)!D!9n!N!X]"
		plot, [0], /nodata, xthick=5., ythick=5.,  xtitle=xtitl, ytitle=ytitl, yrange=[-0.8,2.4], xrange=[-12,-22], xstyle=1, ystyle=1, charsize=1.8, ytickinterval=0.5, yminor=5
...
;------------------------------------------------------------------------------
xyouts, 7.40,1.4,'F8145W-band', size=1.30

xyouts, 9.2,2.0,'(A)', charsize=1.3, color=cc[0]
legend, ["Deimos Sample","MG05","Co09"], color=[0,8,30] , psym=[25,22,21], /clear, charsize=1.1, /right
