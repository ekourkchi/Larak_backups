...
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1.3, xrange=[-0.5,1.6], yrange=[25,17] , color=cc[0],  xstyle=1, ystyle=1, xtitle="Log (R!De!N)!Dkpc!N", ytitle="<!7l!X>!De!N!UF814W!N"
