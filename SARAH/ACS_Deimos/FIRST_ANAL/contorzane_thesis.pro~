...
isophots=strID+"_"+strtrim(N,2)+".ver2.5.isoser.txt"
...
openw, out814, strID+"_"+strtrim(N,2)+".gal.out.ver2.5.sersic.withISOPHOTS.reg", /get_lun
openw, out475, "../"+strID+"_"+strtrim(N475,2)+".gal.out.475.ver2.5.sersic.withISOPHOTS.reg", /get_lun
...
file=strID+"_"+strtrim(N,2)+".gal.out.ver2.5.sersic.withISOPHOTS.fits"
fits_write, file, image, h

file="../"+strID+"_"+strtrim(N475,2)+".gal.out.475.ver2.5.sersic.withISOPHOTS.fits"
