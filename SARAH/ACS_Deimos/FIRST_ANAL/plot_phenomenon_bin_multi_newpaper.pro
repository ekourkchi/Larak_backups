pro plot_phenomenon_bin_multi_newpaper, psout




ps_on , psout, noask='y', /color, cc=cc, xsize=30,ysize=14, scale_factor=0.9
...
xyouts, -20,2.2,'CC=0.65', size=1.3
...
oplot,  [-100,100], trend[0]*[-100,100]+trend[1], linestyle=2, thick=3.
xyouts, 0.1,2.2,'CC=-0.52', size=1.3
...
oplot,  [-100,100], trend[0]*[-100,100]+trend[1], linestyle=2, thick=3.
xyouts, 3.2,2.2,'CC=-0.56', size=1.3
