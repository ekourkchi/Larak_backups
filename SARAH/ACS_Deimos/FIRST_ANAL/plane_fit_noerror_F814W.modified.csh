...
awk -v a=$mu -v b=$re -v c=$sigma '(NR>1){print($a+2.5*log(2*3.1415*$b*$b*0.0025)/log(10)" 0.0 "log($b*0.05*0.463)/log(10)" 0.0 "log($c)/log(10)" 0.0")}' deimos.sersic.sigma.F814W.modified.lst > deimos.sersic.sigma.F814W.${suffix}.modified.lst


awk -v a=$mu -v b=$re -v c=$sigma '(NR>1){print($a+2.5*log(2*3.1415*$b*$b*0.0025)/log(10)" 0.0 "log($b*0.05*0.463)/log(10)" 0.0 "log($c)/log(10)" 0.0")}' matko.sersic.sigma.F814W.modified.lst > matko.sersic.sigma.F814W.${suffix}.modified.lst

awk -v a=$mu -v b=$re -v c=$sigma '(NR>1){print($a+2.5*log(2*3.1415*$b*$b*0.0025)/log(10)" 0.0 "log($b*0.05*0.463)/log(10)" 0.0 "log($c)/log(10)" 0.0")}' cody.sersic.sigma.F814W.modified.lst > cody.sersic.sigma.F814W.${suffix}.modified.lst

more deimos.sersic.sigma.F814W.${suffix}.modified.lst  > all.sersic.sigma.F814W.${suffix}.modified.lst
more matko.sersic.sigma.F814W.${suffix}.modified.lst  >> all.sersic.sigma.F814W.${suffix}.modified.lst
more cody.sersic.sigma.F814W.${suffix}.modified.lst  >> all.sersic.sigma.F814W.${suffix}.modified.lst

setenv filename all.sersic.sigma.F814W.${suffix}.modified.lst
