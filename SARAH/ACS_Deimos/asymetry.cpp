...
// c++ -o asymetry asymetry.cpp -I/home/ir/R/Desktop/cfitsio -Wno-deprecated -lcfitsio
...
//printf("%lf   %lf \n",check, pixels[ii]);
		...
		sum02+=(apixels-*pixels)*(apixels-*pixels);
		sum12+=apixels*apixels;
		sum01+=fabs(apixels-*pixels);
		sum11+=fabs(apixels);
		} else *outpix=0.0;
