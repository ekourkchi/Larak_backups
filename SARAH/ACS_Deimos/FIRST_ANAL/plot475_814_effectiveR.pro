pro plot475_814_effectiveR, psout, limag
...
b0=fit[1]
		...
		plot,  [0], /nodata,  xthick=3., ythick=3.,  xtitle=xtitl, ytitle=ytitl, xstyle=1, ystyle=1, charsize=1.3, yrange=[-0.2,3.50], xrange=[-0.2,1.0], ytickinterval=0.5
