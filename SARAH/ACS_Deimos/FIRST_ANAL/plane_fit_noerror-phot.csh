...
awk -v a=$mu -v b=$re -v c=$sigma '{print($a+2.5*log(2*3.1415*$b*$b*0.0025)/log(10)" 0.0 "log($b*0.05*0.4)/log(10)" 0.0 "log($c)/log(10)" 0.0")}' deimos.all.sersic.sigma-phot.lst > deimos.all.sersic.sigma.${suffix}.lst


awk -v a=$mu -v b=$re -v c=$sigma '{print($a+2.5*log(2*3.1415*$b*$b*0.0025)/log(10)" 0.0 "log($b*0.05*0.4)/log(10)" 0.0 "log($c)/log(10)" 0.0")}' matko.all.sersic.sigma-phot.lst > matko.all.sersic.sigma.${suffix}.lst

awk -v a=$mu -v b=$re -v c=$sigma '{print($a+2.5*log(2*3.1415*$b*$b*0.0025)/log(10)" 0.0 "log($b*0.05*0.4)/log(10)" 0.0 "log($c)/log(10)" 0.0")}' cody.all.sersic.sigma-phot.lst > cody.all.sersic.sigma.${suffix}.lst
