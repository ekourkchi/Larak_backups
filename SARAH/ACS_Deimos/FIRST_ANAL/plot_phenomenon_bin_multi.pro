pro plot_phenomenon_bin_multi, psout




ps_on , psout, noask='y', /color, cc=cc, xsize=20,ysize=16, scale_factor=0.8
...
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1.0,  xrange=[-22,-13.5],yrange=[-0.5,3.2], color=cc[0], xtitle=xtitl, ytitle=ytitl, xstyle=1, ystyle=1
...
xyouts, (-13.5+22)/20-22,2.8,'(a)', color=cc[50], size=0.9
!x.tickformat=xthickformat_origin
!x.tickname=xthickname_origin
!p.charsize=1.0
AXIS, XAXIS=0, xrange=[-22,-13.5], /noerase, xstyle=1
...
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1.0,  xrange=[-0.1,0.7],yrange=[-0.5,3.2], color=cc[0], xtitle=xtitl, ytitle=ytitl , xstyle=1, ystyle=1
...
oploterror, xx,yy,xx*0.0,zz, psym=symcat(9,color=cc[30])
xyouts, (0.7+0.1)/20-0.1,2.8,'(b)', color=cc[50], size=0.9
!x.tickformat=xthickformat_origin
!x.tickname=xthickname_origin
!p.charsize=1.0
AXIS, XAXIS=0, xrange=[-0.1,0.7], /noerase, xstyle=1
...
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1.0,  xrange=[0.8,2.7],yrange=[-0.5,3.2], color=cc[0], xtitle=xtitl, ytitle=ytitl, xstyle=1, ystyle=1





oplot, [0.5,3.0],[0,0],linestyle=3, color=cc[0], thick=1.
...
u=i*0.2
print, u
a=where(x lt 1.1+u and x ge 0.9+u) 
c=y[a]
d=where(c lt 5)
b=stdev(c[d])
yy=[yy,b[0]]
...
oploterror, xx,yy,xx*0.0,zz, psym=symcat(9,color=cc[30])
xyouts, (2.7-0.8)/20+0.8,2.8,'(c)', color=cc[50], size=0.9
!x.tickformat=xthickformat_origin
!x.tickname=xthickname_origin
!p.charsize=1.0
AXIS, XAXIS=0, xrange=[0.8,2.7], /noerase, xstyle=1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;plot_phenomenon, 'n_mu0_v02.ps', 21,5,"!7l!X!D0!N [mag/arcsec!U2!N]", "Log!D10!N(n) [Sersic index]", 0
multiplot
...
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1.0,  xrange=[2.7,4.8],yrange=[-0.5,3.2], color=cc[0], xtitle=xtitl, ytitle=ytitl , xstyle=1, ystyle=1
...
xyouts, (4.8-2.7)/20+2.7,2.8,'(d)', color=cc[50], size=0.9
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;plot_phenomenon, 'n_mu0_v02.ps', 21,5,"!7l!X!D0!N [mag/arcsec!U2!N]", "Log!D10!N(n) [Sersic index]", 0
multiplot
...
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1.0, xtickinterval=0.2, xminor=2., xrange=[-0.45,0.25],yrange=[-0.5,3.2], color=cc[0], xtitle=xtitl, ytitle=ytitl , xstyle=1, ystyle=1





oplot, [-0.4,0.25],[0,0],linestyle=3, color=cc[0], thick=1.
...
u=i*0.1
print, u
a=where(x lt -0.3+u and x ge -0.4+u) 
c=y[a]
d=where(c lt 5)
b=stdev(c[d])
yy=[yy,b[0]]
...
xyouts, (0.25+0.45)/20-0.45,2.8,'(e)', color=cc[50], size=0.9
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;plot_phenomenon, 'n_mu0_v02.ps', 21,5,"!7l!X!D0!N [mag/arcsec!U2!N]", "Log!D10!N(n) [Sersic index]", 0
multiplot
...
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1.0,  xrange=[-0.1,0.8],yrange=[-0.5,3.2], color=cc[0], xtitle=xtitl, ytitle=ytitl , xstyle=1, ystyle=1
...
xyouts, (0.8+0.1)/20-0.1,2.8,'(f)', color=cc[50], size=0.9
