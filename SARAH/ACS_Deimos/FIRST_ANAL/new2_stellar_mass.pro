...
ps_on , psout, noask='y', /color, cc=cc  , xsize=25,ysize=40, scale_factor=0.8,xoffset=3.0
...
aaa=gmp[where(modgmp ne 0)]
bbb=M_dynamics[where(modgmp ne 0)]
ccc=M_s[where(modgmp ne 0)]

for i=0, n_elements(aaa)-1 do print, aaa[i], bbb[i], ccc[i]
...
ytitl="log(R!De!N) [kpc]"
		plot,  bbb, ccc, psym=yoursymbol(27,color=cc[50]),  xthick=5.,ythick=5.,   xstyle=1, ystyle=1, charsize=1.8, ytickinterval=0.5, yminor=5 ,  xtickinterval=1, xminor=4, ytitle=ytitl, yrange=[-0.6,0.6], xrange=[7,11.5]
...
xyouts, 9,-0.3,'a='+strtrim(string(fit[0], FORMAT='(F6.2)'),2)+'!M+!X'+strtrim(string(fit[2],FORMAT='(F5.2)'),2), color=cc[50], size=1.6
xyouts, 9,-0.4,'b='+strtrim(string(fit[1], FORMAT='(F6.2)'),2)+'!M+!X'+strtrim(string(fit[3],FORMAT='(F5.2)'),2), color=cc[50], size=1.6
xyouts, 9,-0.50,'CC='+strtrim(string(correlation([xxx],[yyy]),FORMAT='(F5.2)'),2), size=1.6
xyouts, 7.2,0.40, 'R!De!N !M?!X M!D*!N!U' +strtrim(string(trend[0], FORMAT='(F6.2)'),2), size=2.0;+'!M+!X'+strtrim(string(trend[2],FORMAT='(F5.2)'),2)
...
xtitl="M!D814!N [mag]"
ytitl="log(!7r!X) [Km s!U-1!N]"
		plot,  bbb, ccc, psym=yoursymbol(27,color=cc[50]),  xthick=5.,ythick=5.,   xstyle=1, ystyle=1, charsize=1.8, ytickinterval=0.3, yminor=3 ,  xtickinterval=1, xminor=4, ytitle=ytitl, yrange=[0.8,2.5], xrange=[7,11.5]
...
xyouts, 9,1.4,'a='+strtrim(string(fit[0], FORMAT='(F6.2)'),2)+'!M+!X'+strtrim(string(fit[2],FORMAT='(F5.2)'),2), color=cc[50], size=1.6
xyouts, 9,1.25,'b='+strtrim(string(fit[1], FORMAT='(F6.2)'),2)+'!M+!X'+strtrim(string(fit[3],FORMAT='(F5.2)'),2), color=cc[50], size=1.6
xyouts, 9,1.1,'CC='+strtrim(string(correlation([xxx],[yyy]),FORMAT='(F5.2)'),2), size=1.6
...
xyouts, 7.2,2.3, '!7r!X !M?!X M!D*!N!U' +strtrim(string(trend[0], FORMAT='(F6.2)'),2), size=2.0
...
bbb= modmu814
;ccc= modre814kpc
ccc=M_dynamics[where(modgmp ne 0)]
...
ytitl="log(M!Ddyn!N/M!D!9n!N!X)"
		plot,  bbb, ccc, psym=yoursymbol(27,color=cc[50]),  xthick=5.,ythick=5.,   xstyle=1, ystyle=1, charsize=1.8, ytickinterval=1, yminor=4 ,  xtickinterval=1, xminor=4, ytitle=ytitl, xtitle=xtitl, yrange=[7.0,11.5], xrange=[7,11.5]
...
;xyouts, -16.8,0.50, 'R!De!N !M?!X L!U' +strtrim(string(trend[0]*(-2.50), FORMAT='(F6.2)'),2)+'!M+!X'+strtrim(string(trend[2]*(2.5),FORMAT='(F5.2)'),2), size=2.0
xyouts, 7.2,10.75, 'M!Ddyn!N !M?!X M!D*!N!U' +strtrim(string(trend[0], FORMAT='(F6.2)'),2), size=2.0
oplot,  [-80,80], trend[0]*[-80,80]+trend[1], linestyle=2, thick=4.
oplot,  [-80,80], [-80,80], linestyle=1, thick=4.
