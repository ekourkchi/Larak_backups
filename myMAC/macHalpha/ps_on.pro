PRO ps_on, file_name, font_size, ysize, yoffset=yoffset, color=color, cc=cc, $
...
;** set plot to postscipt and call device
  ...
  device, landscape=landscape, portrait=portrait, encapsulated=encapsulated, $
    file=file_name, font_size=font_size, color=color, $
    xsize=xsize, xoffset=xoffset, ysize=ysize, yoffset=yoffset
