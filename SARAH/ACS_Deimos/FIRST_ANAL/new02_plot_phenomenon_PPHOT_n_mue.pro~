pro new02_plot_phenomenon_PPHOT_n_mue, psout


;  new02_plot_phenomenon_PPHOT_n_mue, 'testjagour03_v2.ps'    
...
h1=-0.16
v=0.15
plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.3,1.1], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3.,ytitle='log(n)', xtitle='a*log(R!De!N)+b*<!7l!X!De!N>!D(814)!N+c'
ans=ortptrend(y,x,z)
print, ans
...
h=-0.17
h1=-0.16
plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.3,1.1], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3., xtitle='a*log(R!De!N)+b*<!7l!X!De!N>!D(814)!N+c'
ans=ortptrend(y,x,z)
...
!p.charsize=1.4
AXIS, XAXIS=0,xrange=[-0.70,1.0], xstyle=1, xtickinterval=0.3, xminor=3, /noerase, xtitle='a*log(R!De!N)+b*<!7l!X!De!N>!D(814)!N+c'
...
;h=-0.17
;h1=-0.16
;plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.3,1.1], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3., xtitle='a*log(R!De!N)+b*<!7l!X!De!N>!D(814)!N+c',ytitle='log(n)';
;ans=ortptrend(y,x,z)
