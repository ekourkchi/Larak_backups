...
sexcat='norm'+ID+'_SII.gain.r.cat'
matchcat=ID+'_R.gain.match'
output='norm'+ID+'_SII.gain.r.sdss1'
;output0=ID+'.sdss0'


readcol, sexcat, no, ximage, yimage, wcs1, wcs2, flux, fluxerr, magaut, magauterr, SKIPLINE=9,format='F,D,D,D,D,D,D,D,D', /SILEN
readcol, matchcat, x1, y1, x2, y2, starno, sexcatno, /SILENT
