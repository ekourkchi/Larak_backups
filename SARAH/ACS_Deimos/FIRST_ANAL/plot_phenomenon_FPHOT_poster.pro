pro plot_phenomenon_FPHOT_poster, psout




ps_on , psout, noask='y', /color, cc=cc
device,filename=psout,xsize=20,ysize=15,xoffset=1.0
!y.margin=5
!x.margin=8.
...
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1.3,  xrange=[14.5,25],yrange=[16.5,23.5], color=cc[0],  ytitle=ytitl , xtitle=xtitl, xstyle=1, ystyle=1
...
xyouts, 15.25,22.0,'(P.P.)', color=cc[50], size=1.2
...
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1.3,  xrange=[14.5,25],yrange=[16.5,23.5], color=cc[0],  xstyle=1, ystyle=1, xtitle=xtitl
...
xyouts, 15.25,22.0,'(F.P.)', color=cc[50], size=1.1
