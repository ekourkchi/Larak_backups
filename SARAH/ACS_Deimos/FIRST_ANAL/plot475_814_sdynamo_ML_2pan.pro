pro plot475_814_sdynamo_ML_2pan, psout, limag
...
ps_on , psout, noask='y', /color, cc=cc  , xsize=18,ysize=15, scale_factor=1;, 
...
;------------------------------------------------------------------------------
xyouts, 7.40,1.4,'F814W-band', size=1.30, color=cc[50]

;xyouts, 9.2,2.0,'(A)', charsize=1.3, color=cc[0]
legend, ["Existing DEIMOS Sample","MG05","Co09"], color=[0,8,30] , /clear, charsize=1.1, box=0



oplot, [7.2], [2.13] , psym= yoursymbol(27,color=cc[0])
oplot, [7.2], [1.95] , psym= yoursymbol(29,color=cc[8])
oplot, [7.2], [1.78] , psym= yoursymbol(28,color=cc[30])
