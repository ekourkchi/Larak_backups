pro new02_plot_phenomenon_FPHOT_RE, psout
...
h1=0.04
v=0.15
plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.5,0.9], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3.,ytitle='log(R!De!N) [kpc]', xtitle='a*log(!7r!X)+b*<!7l!X!De!N>!D(814)!N+c'
ans=ortptrend(z,x,y)
print, ans
...
xyouts, 0.85,0.8,'(A)', color=cc[50], size=1.1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
multiplot
...
h=0.03
h1=0.04
plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.5,0.9], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3., xtitle='a*log(!7r!X)+b*<!7l!X!De!N>!D(814)!N+c'
ans=ortptrend(z,x,y)
print, ans
ans0=ortptrenderror(z,x,y,zer,xer,yer,iter)
print, ans0
...
xyouts, px,py-0.2,'c='+strtrim(string(ans[2], FORMAT='(F5.2)'),2)+'!M+!X'+strtrim(string(ans0[5], FORMAT='(F5.2)'),2), color=cc[0], size=1.2
;xyouts, 21.0,18.1,'(FP-F814W)', color=cc[50], size=1.1
xyouts, 0.85,0.8,'(B)', color=cc[50], size=1.1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
multiplot
...
h=0.03
h1=0.04
plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.5,0.9], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3.
ans=ortptrend(z,x,y)
print, ans
ans0=ortptrenderror(z,x,y,zer,xer,yer,iter)
print, ans0
...
!p.charsize=1.4
AXIS, XAXIS=0,xrange=[-0.70,1.0], xstyle=1, xtickinterval=0.3, xminor=3, /noerase, xtitle='a*log(!7r!X)+b*<!7l!X!De!N>!D(814)!N+c'
...
xyouts, px,py-0.2,'c='+strtrim(string(ans[2], FORMAT='(F5.2)'),2)+'!M+!X'+strtrim(string(ans0[5], FORMAT='(F5.2)'),2), color=cc[0], size=1.2
;xyouts, 21.0,18.1,'(FP-F814W)', color=cc[50], size=1.1
xyouts, 0.85,0.8,'(C)', color=cc[50], size=1.1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;multiplot
...
;h=0.03
;h1=0.04
;plot, [0], /nodata, xthick=4.,ythick=4., charsize=1.4, xrange=[-0.70,1.0], yrange=[-0.5,0.9], xstyle=1, ystyle=1, xtickinterval=0.3, xminor=3., xtitle='a*log(!7r!X)+b*<!7l!X!De!N>!D(814)!N+c',ytitle='log(R!De!N)!Dkpc!N'
;ans=ortptrend(z,x,y)
;print, ans
;ans0=ortptrenderror(z,x,y,zer,xer,yer,iter)
;print, ans0
...
;xyouts, px,py-0.2,'c='+strtrim(string(ans[2], FORMAT='(F5.2)'),2)+'!M+!X'+strtrim(string(ans0[5], FORMAT='(F5.2)'),2), color=cc[0], size=1.2
		;xyouts, 21.0,18.1,'(FP-F814W)', color=cc[50], size=1.1
;xyouts, 0.85,0.8,'(D)', color=cc[50], size=1.1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;multiplot
...
;xyouts, px,py-0.2,'c='+strtrim(string(ans[2], FORMAT='(F5.2)'),2)+'!M+!X'+strtrim(string(ans0[5], FORMAT='(F5.2)'),2), color=cc[0], size=1.2
		;xyouts, 21.0,18.1,'(FP-F814W)', color=cc[50], size=1.1
;xyouts, 0.85,0.8,'(E)', color=cc[50], size=1.1
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
