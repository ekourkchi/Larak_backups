;------------------------------------------------------------------------------
pro ACS_m_sigma3_Rsdss_paperv03,  psout, NUM
xbegin=-21.
ymax=2.5
qp=0.4
...
plot, [0], /nodata, xthick=2.,ythick=2.,charsize=0.9, xtickinterval=1., xminor=2., xrange=[xbegin,-13], ytickinterval=0.1, yminor=2, yrange=[1.0,ymax], xtitle='!6SDSS M!Dg!N (Mag)', ytitle='!6log!D10!N !7r!6 Km/s',title=' ', color=cc[0]
...
MAGTOT=[MAGTOT,MAG0]                           ;  MAGTOT is  CODY+MATKOVIC+DEIMOS
SIGTOT=[SIGTOT,sigma0]
ERSIGTOT=[ERSIGTOT,ersigma0]
...
!P.color=cc[0]
!P.thick=3.
legend, item, linestyle=lstyle, color=c_colors , psym=sym, /clear, /bottom, charsize=0.8, box=0.
...
xyouts, -18.55-qp,2.25,lable, color=cc[0],size=1.2
oplot, [-19.05-qp,-18.65-qp],[2.27,2.27],linestyle=2., color=cc[50],thick=5.,psym=0.
...
da1=fit[6]
da0=fit[7]
print, "ORTOGONAL", a1, da1, a0, da0, "    n:", -1.0*a1/2.5, da1/2.5
...
lable='Ortogonal Fit: !6L!9?!X!7r!U'+strtrim(string(-1.0*a1/2.5, FORMAT='(F5.2)'),2)+'!9+!X'+strtrim(string(da1/2.5, FORMAT='(F5.2)'),2)+'!6'
xyouts, -18.77-qp,2.35,lable, color=cc[0],size=1.2
