...
;print, x
ps_on , 'norm'+ID+'.ps',  noask='y', /color, cc=cc
!p.font=0
plot, [0], /nodata, xthick=3.,ythick=3.,charsize=1, xtickinterval=0.2, xminor=2, xrange=[minn,maxx], yrange=[0,max(hist)+10.], yminor=5, xtitle='Delta R [Magnitude] (image-SDSS)', ytitle='!6Number of Objects',title=' ', color=cc[0]
...
!P.color=cc[0]
!P.thick=3.
legend, item, linestyle=lstyle,color=c_colors ,/clear,/right_legend, charsize=1
