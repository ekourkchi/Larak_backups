...
;==========================
; PLOT  PLOT
minn0=floor(median(deltot)*10)/10.-0.6
maxx0=floor(median(deltot)*10)/10.+0.6

minn=30.-maxx0-6.193-.2   ; 6.193=2.5*log10(300s) images not normalized into 300sec exposure time
maxx=30.-minn0-6.193
deltot_1=30.-deltot_1-6.193
delstar_1=30.-delstar_1-6.193
deltot_2=30.-deltot_2-6.193
delstar_2=30.-delstar_2-6.193
deltot_3=30.-deltot_3-6.193
delstar_3=30.-delstar_3-6.193
deltot_4=30.-deltot_4-6.193
delstar_4=30.-delstar_4-6.193
...
ps_on , ID+'.chips.ps',  noask='y', /color, cc=cc
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
multiplot
plot, [0], /nodata, xthick=5.,ythick=5.,charsize=1.0, xtickinterval=0.5, ytickinterval=15., xminor=5, xrange=[minn-0.2,maxx], yrange=[0,max(hist_1)+15.], yminor=5, color=cc[0],  title='', ystyle=1, xstyle=1, ytitle='No. of Objects'
;------------------------------------------------------------
item='All OBJECTS'
lstyl=0
lstyle=lstyl
...
oplot, x,hist1_1,  psym=10., thick=4., color=cc[colorss], linestyle=lstyl
;------------------------------------------------------------
hh=0.72*((max(hist_1)+15.))
hh1=0.7*((max(hist_1)+15.))
hh2=0.78*((max(hist_1)+15.))


;polyfill, [floormin+0.08,floormin+0.08,floormin+0.35,floormin+0.35]-0.15*[1,1,1,1],[hh1,hh2,hh2,hh1],color=cc[11]
xyouts, floormin+0.1-0.15,hh,'chip:1', size=1
!P.color=cc[0]
!P.thick=3.
legend, item, linestyle=lstyle,color=c_colors , charsize=.65, spacing=0.6, /horizontal
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;


multiplot
!p.charsize=1.0
plot, [0], /nodata, xthick=5.,ythick=5.,charsize=1.0, xtickinterval=0.5, ytickinterval=15., xminor=5, xrange=[minn-0.2,maxx], yrange=[0,max(hist_2)+15.], yminor=5, color=cc[0],  title='', ystyle=1, xstyle=1
;------------------------------------------------------------
item='All OBJECTS'
lstyl=0
lstyle=lstyl
...
colorss=0
c_colors=[c_colors,colorss]
oplot, x,hist1_2,  psym=10., thick=4., color=cc[colorss], linestyle=lstyl
;------------------------------------------------------------
!y.tickformat=ythickformat_origin
!y.tickname=ythickname_origin
!p.charsize=1.0

AXIS, YAXIS=1, yrange=[0,max(hist_2)+15.], yminor=5,ythick=5., ytickinterval=15., /noerase, ystyle=1

hh=0.72*((max(hist_2)+15.))
hh1=0.7*((max(hist_2)+15.))
hh2=0.78*((max(hist_2)+15.))



;polyfill, [floormin+0.08,floormin+0.08,floormin+0.35,floormin+0.35]-0.15*[1,1,1,1],[hh1,hh2,hh2,hh1],color=cc[11]
xyouts, floormin+0.1-0.15,hh,'chip:2', size=1
!P.color=cc[0]
!P.thick=3.
legend, item, linestyle=lstyle,color=c_colors , charsize=.65, spacing=0.6, /horizontal
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
multiplot  
plot, [0], /nodata, xthick=5.,ythick=5.,charsize=1.0, xtickinterval=0.5, ytickinterval=15., xminor=5, xrange=[minn-0.2,maxx], yrange=[0,max(hist_3)+13.], yminor=5, color=cc[0],   xtitle='Delta Mag.', title='', ystyle=1, xstyle=1, ytitle='No. of Objects'
...
colorss=0
c_colors=[c_colors,colorss]
oplot, x,hist1_3,  psym=10., thick=4., color=cc[colorss], linestyle=lstyl
polyfill,[ceil(maxx/0.2)*0.2-0.1,ceil(maxx/0.2)*0.2-0.1,ceil(maxx/0.2)*0.2+0.1,ceil(maxx/0.2)*0.2+0.1],[-8,-2,-2,-8],color=cc[10]

hh=0.72*((max(hist_3)+15.))
hh1=0.7*((max(hist_3)+15.))
hh2=0.78*((max(hist_3)+15.))



;polyfill, [floormin+0.08,floormin+0.08,floormin+0.35,floormin+0.35]-0.15*[1,1,1,1],[hh1,hh2,hh2,hh1],color=cc[11]
xyouts, floormin+0.1-0.15,hh,'chip:3', size=1
!P.color=cc[0]
!P.thick=3.
legend, item, linestyle=lstyle,color=c_colors , charsize=.65, spacing=0.6, /horizontal
...
multiplot  
plot, [0], /nodata, xthick=5.,ythick=5.,charsize=1.0, xtickinterval=0.5, ytickinterval=15., xminor=5, xrange=[minn-0.2,maxx], yrange=[0,max(hist_4)+13.], yminor=5, color=cc[0],   xtitle='Delta Mag.', title='', ystyle=1, xstyle=1
...
colorss=0
c_colors=[c_colors,colorss]
oplot, x,hist1_4,  psym=10., thick=4., color=cc[colorss], linestyle=lstyl
;------------------------------------------------------------
!y.tickformat=ythickformat_origin
!y.tickname=ythickname_origin
!p.charsize=1.0

AXIS, YAXIS=1, yrange=[0,max(hist_4)+13.], yminor=5,ythick=5.,ytickinterval=15., /noerase, ystyle=1 

;polyfill, [floormin-0.1,floormin-0.1,floormin+0.1,floormin+0.1],[-8,-2,-2,-8],color=cc[10]


hh=0.72*((max(hist_4)+13.))
hh1=0.7*((max(hist_4)+13.))
hh2=0.78*((max(hist_4)+13.))



;polyfill, [floormin+0.08,floormin+0.08,floormin+0.35,floormin+0.35]-0.15*[1,1,1,1],[hh1,hh2,hh2,hh1],color=cc[11]
xyouts, floormin+0.1-0.15,hh,'chip:4', size=1
!P.color=cc[0]
!P.thick=3.
legend, item, linestyle=lstyle,color=c_colors , charsize=.65, spacing=0.6, /horizontal
